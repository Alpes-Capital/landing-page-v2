...
import { useCssTheme } from '@components/css-theme'
import { Theme1 } from '@components/global-style'
import LogoLightBg from '@public/images/global/big_whitebg.svg'
import LogoDarkBg from '@public/images/global/big_blackbg.svg'
...
const Nav: React.FC<NavProps> = ({isDarkTheme, setTheme, miniMenuState, setMiniMenu, routes}) => {
   ...
   const currTheme = useCssTheme().get() as { palette?: Record<string, string> }
   ...
   return (
      <>
         ...
         role="navigation">
            <div id="background" />
            {currTheme.palette?.background === Theme1.palette.background ? 
               <LogoLightBg id='logo' /> : 
               <LogoDarkBg id='logo' /> 
            }
